...
if ($limit == 0 && $limit2 == 0 ) echo '';
 ...
 if($params2[0] == "" || $params2[0] == "/" || $params2[0] == " "){
  ...
  <div class="noticiaHome">
    ...
    <h2>
        <a target="_BLANK" href="<?php echo $item->get_permalink(); ?>" title="<?php echo $item->get_date('j F Y @ G:i'); ?>">
  ...
  <div class="noticiaHome">
    ...
    <h2>
        <a target="_BLANK" href="<?php echo $items2[$key]->get_permalink(); ?>" title="<?php echo $items2[$key]->get_date('j F Y @ G:i'); ?>">
            <?php echo $items2[$key]->get_title(); ?>
        </a>
    </h2>
