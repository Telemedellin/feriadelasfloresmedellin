...
<head>
    ...
    <script>
        ...
        jQuery(document).ready(function($){
            ...
            $('.calendario' ).Calendar({ 'events': evnts, 'weekStart': 1 }).on('changeDay', function(event)
            {
            ...
            <div id="cabezoteAlcaldia"  class="clearfix">	
                ...
                <div class="logosAlcaldia">
                    <div class="redesAlcaldia">
                        <ul>
                            <li>
                                <a href="http://www.facebook.com/alcaldiademed" target="_blank" title="Facebook"><img src="<?php bloginfo('template_directory'); ?>/images/Facebook.png" /></a>
                            </li>
                            <li>
                                <a href="http://twitter.com/alcaldiademed" target="_blank" title="Twitter"><img src="<?php bloginfo('template_directory'); ?>/images/Twitter.png" /></a>
                            </li>
                            <li>
                                <a href="http://www.youtube.com/alcaldiademed" target="_blank" title="Youtube"><img src="<?php bloginfo('template_directory'); ?>/images/Youtube.png" /></a>
                            </li>
                            <li>
                                <a href="http://www.flickr.com/photos/90282908@N03/" target="_blank" title="Flickr"><img src="<?php bloginfo('template_directory'); ?>/images/Flickr.png" /></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="navbar">
                <div class="container-fluid nav-container">
                    <nav id="main-menu" role="navigation" class="row-fluid">
                        ...
                        <div id="main_nav" class="span9">
                            ...
                            <ul class="menu menuholder">
                                <li class="menu_programacion">
                                    <a href="<?php echo home_url(); ?>/programacion/" title="Programación">Programación</a>
                                </li>
                                <li class="menu_turistica">
                                    <a href="<?php echo home_url(); ?>/infoturistica/" title="Info Turística">Info Turística</a>
                                </li>
                                <li class="menu_historia">
                                    <a href="<?php echo home_url(); ?>/historia/" title="Historia">Historia</a>
                                </li>
                                <li class="menu_saladeprensa">
                                    <a href="<?php echo home_url(); ?>/saladeprensa/" title="Sala de Prensa">Sala de Prensa</a>
                                </li>
                                <li class="menu_contactenos">
                                    <a href="<?php echo home_url(); ?>/contacto" title="Contáctenos">Contáctenos</a>
                                </li>
                                <li class="menu_envivo">
                                    <a href="<?php echo home_url(); ?>/la-feria-en-vivo/" title="En Vivo">En Vivo</a>
                                </li>
                            </ul>
                            <?php else: ?>
                            <ul class="menuEn menuholderEn"> 
                                <li class="menu_programacion">
                                    <a href="<?php echo home_url(); ?>/en/programacion/" title="Programación">Schedule</a>
                                </li>
                                <li class="menu_turistica">
                                    <a href="<?php echo home_url(); ?>/en/infoturistica/" title="Info Turística">For Turist</a>
                                </li>
                                <li class="menu_historia">
                                    <a href="<?php echo home_url(); ?>/en/historia/" title="Historia">History</a>
                                </li>
                                <li class="menu_saladeprensa">
                                    <a href="<?php echo home_url(); ?>/en/saladeprensa/" title="Sala de Prensa">Press Room</a>
                                </li>
                                <li class="menu_contactenos">
                                    <a href="<?php echo home_url(); ?>/en/contacto/" title="Contact us">Contact us</a>
                                </li>
                                <li class="menu_envivo">
                                    <a href="<?php echo home_url(); ?>/en/la-feria-en-vivo/" title="En Vivo">La Feria Live</a>
                                </li>
                            </ul>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="row-fluid barra-menu">
                        ...
                        <div class="buscador visible-desktop">
                            <?php if(qtrans_getLanguage() == 'es'): ?>
                                ...
                                <fieldset>
                                    <div class="clearfix">
                                        <div class="input-append input-prepend">
                                            ...
                                            <input type="text" name="s" id="search" placeholder="Buscar" value="" class="placeholder">
