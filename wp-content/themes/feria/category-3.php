        ...
        <div id="main" class="span8 clearfix" role="main">
            ...
            <?php if(qtrans_getLanguage() == 'es'): ?>
                <a href="<?php echo home_url(); ?>/saladeprensa/acreditacion-de-prensa-para-la-feria-de-las-flores-2014/">
                    Si quieres acreditarte como periodista, haz clic aquí
                </a>
            <?php else: ?>
                <a href="<?php echo home_url(); ?>/saladeprensa/acreditacion-de-prensa-para-la-feria-de-las-flores-2014/">
                ...
                <div class="kitdeprensa">
                    ...
                    <div class="clearfix row-fluid">
                        <div class="span6 logoDescarga">
                            <span class="descarga">
                                <a href="<?php bloginfo('template_directory'); ?>/descargables/logos.zip"><?php if(qtrans_getLanguage() == 'es'): ?>Descargar logo<?php else: ?>Download logo <?php endif; ?> </a>
                            </span>   
                        </div>
                        <div class="span6 galeriaFeriaD">
                            ...
                            <span class="descarga">
                                <a href="https://www.flickr.com/photos/alcaldiademed/sets/72157634775199157/" target="_blank"><?php if(qtrans_getLanguage() == 'es'): ?>Ver galería: Feria de las flores 2012<?php else: ?>Gallery: Feria de las Flores 2012<?php endif; ?></a>
                            </span>
                        </div>
                    ...
                    <div class="clearfix row-fluid">
                        <div class="span6 galeriaFeriaD">
                            ...
                            <span class="descarga">
                                <a href="https://www.flickr.com/photos/alcaldiademed/sets/72157634919666530/" target="_blank"><?php if(qtrans_getLanguage() == 'es'): ?>Ver galería: Desfile de silleteritos 2013<?php else: ?>Gallery: Desfile de silleteritos 2013<?php endif; ?></a>
                            </span>
                        </div>
                        <div class="span6 galeriaFeriaD">
                            <!-- Galería de Medellín -->
                            ...
                            <span class="descarga">
                                <a href="https://www.flickr.com/photos/alcaldiademed/sets/72157639647576673/" target="_blank"><?php if(qtrans_getLanguage() == 'es'): ?>Ver galería: Imágenes de Medellín<?php else: ?>Gallery: Pictures of Medellín<?php endif; ?></a>
                            </span>
                        </div>
                    </div>
                    <!-- cierra row -->
                    ...
                    <div class="clearfix row-fluid">
                        <div class="span6 logoDescarga">
                            <!-- Progrmación -->
                            <span class="descarga">
                                <a href="<?php bloginfo('template_directory'); ?>/descargables/Programacion.pdf"><?php if(qtrans_getLanguage() == 'es'): ?>Descargar programación<?php else: ?>Download Schedule<?php endif; ?></a>
                            </span>
                        </div>
                        <div class="span6 logoDescarga">
                            <span class="descarga">
                                <a href="<?php bloginfo('template_directory'); ?>/descargables/Programacion_hd.pdf"><?php if(qtrans_getLanguage() == 'es'): ?>Descargar programación HD<?php else: ?>Download Schedule HD<?php endif; ?></a>
                            </span>
                        </div>
                    </div>
                    <!-- cierra row -->
                    ...
                    <div class="clearfix row-fluid" style="display:none;">
                        <div class="span6 videoFeria">
                            ...
                            <span class="descarga">
                                <a href="#">Descargar video</a>
                            </span> 
                        </div>
                        <div class="span6 logoDescarga">
                            <span class="descarga">
                                <a href="#">Descargar cuña</a>
                            </span>
                        </div>
                    </div>
                    <!-- cierra row -->
