    ...
    <div id="content" class="clearfix row-fluid">
        <div id="main" class="span8 clearfix" role="main">
            ...
            <div class="contenido-texto">
                ...
                <p>Además, también podrás descargar el PDF con toda la programación oficial de la Feria de las Flores 2015 en el siguiente enlace.</p>
                <?php else: ?>
                ...
                <p>In addition, you can also download the PDF with all the official program of the 2015 Fair Flowers on the link below.</p>
                <?php endif; ?>
            </div>
            <div class="descargarProgramacion row-fluid"> 
                <div class="low span6">
                    <?php if(qtrans_getLanguage() == 'es'): ?>
                    <a id="programacion-baja" href="http://feriadelasfloresmedellin.gov.co/wp-content/uploads/2015/07/programacion-feria-de-las-flores-2015.pdf" class="btn" target="_blank">
                        Programación en PDF
                    </a>
                    <?php else: ?>
            ...
            <div>
                <section id="options" class="clearfix">
                    <ul id="filters" class="option-set clearfix" data-option-key="filter">
                        ...
                        <li class="span3">
                            <a href="#filter" data-option-value=".manana">
                            <?php if(qtrans_getLanguage() == 'es'): ?>
                                Mañana
                            <?php else: ?>
                                Morning
                        ...
                        <li class="span3">
                            <a href="#filter" data-option-value=".tarde">
                            <?php if(qtrans_getLanguage() == 'es'): ?>
                                Tarde
                            <?php else: ?>
                                Afternoon
                ...
                <p class="titulo-programacion">
                    <span class="icono-filters"></span>Eventos organizados por la Alcaldía de Medellín
                </p>
                <!-- #options -->
                ...
                <div id="container" class="clearfix">
                    ...
                    <a href="<?php the_permalink(); ?>">
                        <div class="element <?php echo $class.' '.$evento_class ?>">
                            ...
                            <ul>
                                <li>
                                    <i class="icon-time"></i> <strong> Hora:</strong> <?php echo $humanHoraInicio ?> <?php echo ($tieneHoraFin) ? " a $humanHoraFin" : "" ?>
                                </li>
                                <li>
                                    <i class="icon-map-marker"></i> <strong>Lugar:</strong> <?php echo $lugar ?>
                                </li>
                                <li>
                                    <i class="icon-star"></i> <strong>Teléfono:</strong> <?php echo $telefono ?>
                                </li>
                            </ul>
                        </div>
                    </a>
                    <?php
                        ...
                        while ( $myQuery->have_posts() ) : $myQuery->the_post();
                            ...
                            if($fechaSeleccionada >= $fechaInicio AND $fechaSeleccionada <= $fecha_fin):
                                $evento_class = '';
                                $posttags = get_the_tags();
                                if ($posttags)
                                {
